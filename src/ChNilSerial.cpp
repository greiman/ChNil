 ...
 */
 /**
 * @file    ChNilSerial.cpp
 * @brief   Nil RTOS serial library source
 *
 * @defgroup Serial ChNilSerial
...
int ChNilSerialClass::available() {
 ...
 * @param[in] baud rate
 */
void ChNilSerialClass::begin(unsigned long baud) {
 ...
 * @return 1
 */
size_t ChNilSerialClass::write(uint8_t b) {
