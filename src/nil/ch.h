...
#define THD_TABLE_END {THD_IDLE_BASE, THD_IDLE_END, "idle", NULL, NULL}};     \
size_t chCfgNumThreads = sizeof(nil_thd_configs)/sizeof(thread_config_t) - 1; \
thread_t nil_threads[sizeof(nil_thd_configs)/sizeof(thread_config_t)];

extern size_t chCfgNumThreads;
extern thread_t nil_threads[];
//------------------------------------------------------------------------------
#else  // WHG_MOD
/**
 * @name    Threads tables definition macros
